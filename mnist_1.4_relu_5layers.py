...
W1 = tf.Variable(tf.random_normal([784, n1], stddev=stddev))
# biases b[10]
b1 = tf.Variable(tf.random_normal([n1], stddev=stddev))

n2 = 100
W2 = tf.Variable(tf.random_normal([n1, n2], stddev=stddev))
b2 = tf.Variable(tf.random_normal([n2], stddev=stddev))

n3 = 60
W3 = tf.Variable(tf.random_normal([n2, n3], stddev=stddev))
b3 = tf.Variable(tf.random_normal([n3], stddev=stddev))

n4 = 30
W4 = tf.Variable(tf.random_normal([n3, n4], stddev=stddev))
b4 = tf.Variable(tf.random_normal([n4], stddev=stddev))

out = 10
# weights W[784, 10]   784=28*28
W = tf.Variable(tf.random_normal([n4, out], stddev=stddev))
# biases b[10]
b = tf.Variable(tf.random_normal([out], stddev=stddev))
